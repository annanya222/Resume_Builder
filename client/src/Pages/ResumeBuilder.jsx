      ...
      <div className='max-w-7xl mx-auto px-4 pb-8' >
       <div className='grid lg:grid-cols-12 gap-8' >
           ...
           <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1' >
            ...
            style={{width: sections.length > 1 ? `${(activeSectionIndex * 100) / (sections.length - 1)}%` : '0%',}}/>
            ...
            ring-green-300 text-green-700 ring hover:ring-green-400 transition-all
            rounded-md px-6 py-2 mt-6 text-sm'>Save Changes</button>
           </div>
           </div>
             ...
             from-purple-100 to-purple-200 text-purple-600 rounded-lg
              ring-purple-300 hover:ring transition-colors'>
                 {resumeData.public ? <EyeIcon className="size-4"/>:
                  ...
                  {resumeData.public ? 'Public' : 'Private'} </button>
