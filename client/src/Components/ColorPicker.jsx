...
{ name: "Black", value: "#1F2937" }
  ...
  return (
    <div className='relative'>
      <button onClick={()=> setIsOpen(!isOpen)} className='flex items-center gap-1 text-sm text-pink-600
      bg-gradient-to-br from-pink-50 to bg-pink-100 ring-pink-300 hover:ring
