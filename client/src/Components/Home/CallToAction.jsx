...
<p className="text-xl font-medium max-w-md text-slate-800">Create professional resumes with smart AI support.</p>
<Link to='/app' className="flex items-center gap-2 rounded py-3 px-8 bg-red-600 hover:bg-red-700 transition text-white">
