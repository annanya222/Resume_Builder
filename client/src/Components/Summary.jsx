   ...
   return (
    <div className='space-y-4' >
     ...
     <p className='text-sm text-gray-500' >Add summary for your resume here</p>
      ...
      <button disabled={isGenerating} onClick={generateSummary} className='flex itmes-center gap-2 px-3 py-1 text-sm bg-red-100
      text-red-700 rounded hover:bg-red-200 transition-colors
      disabled:opacity-50'> 
      ...
      <div className="mt-6">
        ...
        focus:border-blue-500 outline-none transition-colors resize-none' placeholder='Write a short summary about yourself, your skills and the kind of role you are looking for...' />
